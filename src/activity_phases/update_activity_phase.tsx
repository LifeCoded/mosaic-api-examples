...
async function updateActivityPhase(teamId: number, activityPhaseId: number, updateData: ActivityPhaseUpdateData): Promise<void> {
  try {
    const response = await api.put(`/api/${teamId}/activity_phase_id/${activityPhaseId}`, updateData);
...
// Example usage of updating an activity phase
