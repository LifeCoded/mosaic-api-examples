...
async function createDependency(teamId: number, postData: DependencyData): Promise<void> {
    try {
        const response = await api.post(`/api/${teamId}/dependencies`, postData);
...
// Example usage of creating a dependency between two work plans
...
createDependency(12345, dependencyData);